...
Kystsoft::VarioSoundSettings::VarioSoundSettings()
{
...
void Kystsoft::VarioSoundSettings::sortSoundPoints()
{
	std::sort(soundPoints.begin(), soundPoints.end());
}

float Kystsoft::VarioSoundSettings::frequency(float climb) const
{
...
float Kystsoft::VarioSoundSettings::period(float climb) const
{
	if (soundPoints.empty())
...
float Kystsoft::VarioSoundSettings::duty(float climb) const
{
	if (soundPoints.empty())
...
size_t Kystsoft::VarioSoundSettings::soundPointInterval(float climb) const
{
	if (soundPoints.size() > 2)
	{
		size_t i = 0;
